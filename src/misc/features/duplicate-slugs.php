...
/**
 * Class for handling the duplicate slugs feature.
 */
class Duplicate_Slugs extends Feature_Base {
     ...
     * @var string
     */
    protected $setting_key = 'allow_duplicate_slugs';
            ...
            <td>
                <label>
                    <input type="checkbox" 
                           ...
                           value="1" 
                           <?php checked(isset($settings['allow_duplicate_slugs']) && $settings['allow_duplicate_slugs']); ?> />
